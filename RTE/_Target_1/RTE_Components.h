...
/* ARM::Acceleration:Arm-2D Extras:Controls:1.5.3 */
#define RTE_Acceleration_Arm_2D_Extra_Controls
/* ARM::Acceleration:Arm-2D Extras:LCD ASCII Printf:2.1.0 */
#define RTE_Acceleration_Arm_2D_Extra_LCD_printf__
/* ARM::Acceleration:Arm-2D Helper:Display Adapter:1.7.3 */
...
/* ARM::Acceleration:Arm-2D Helper:PFB:1.7.7 */
#define RTE_Acceleration_Arm_2D_Helper_PFB
/* ARM::Acceleration:Arm-2D Helper:RTOS Helper:CMSIS-RTOS2:1.1.0 */
