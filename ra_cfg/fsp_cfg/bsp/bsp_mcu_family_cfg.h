...
#define BSP_TZ_CFG_DPFSAR ((RA_NOT_DEFINED > 0) ? 0xFFEC0000U : 0xFFFFFFFFU)
#endif
...
#define BSP_TZ_CFG_ICUSARE ((RA_NOT_DEFINED > 0) ? 0x00E2FFFFU : 0xFFFFFFFFU)
#endif

            /* Security attribution registers for WUPEN1. */
#ifndef BSP_TZ_CFG_ICUSARF
#define BSP_TZ_CFG_ICUSARF ((RA_NOT_DEFINED > 0) ? 0xFFFF80F7U : 0xFFFFFFFFU)
#endif
 ...
 * SRAM0WTEN and therefore there is no reason to access PRCR2. */
    ...
    #define BSP_TZ_CFG_NON_SECURE_APPLICATION_FALLBACK (1U)
            ...
            #define BSP_CFG_ROM_REG_OFS1_SEL (0xFCF0F0D0U | ((BSP_CFG_CLOCKS_SECURE == 0) ? 0xF00U : 0U) | ((RA_NOT_DEFINED > 0) ? 0U : 0x2FU))
#else
