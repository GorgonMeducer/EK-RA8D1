...
#if (BSP_CFG_XTAL_HZ > (26000000))
 #define CGC_MAINCLOCK_DRIVE    (0x05U)
#elif (BSP_CFG_XTAL_HZ > (20000000)) && (BSP_CFG_XTAL_HZ <= (26000000))
 #define CGC_MAINCLOCK_DRIVE    (0x03U)
#elif (BSP_CFG_XTAL_HZ > (16000000)) && (BSP_CFG_XTAL_HZ <= (20000000))
 #define CGC_MAINCLOCK_DRIVE    (0x2U)
#elif (BSP_CFG_XTAL_HZ > (8000000)) && (BSP_CFG_XTAL_HZ <= (16000000))
...
#define BSP_FEATURE_BSP_OFS_HAS_SECURITY_ATTRIBUTION         (0)          // Feature not available on this MCU
...
#define BSP_FEATURE_CGC_MODRV_MASK                           (0x0U)     // This MCU does not have MOMCR.MODRV
#define BSP_FEATURE_CGC_MODRV_SHIFT                          (0x0U)     // This MCU does not have MOMCR.MODRV
...
#define BSP_FEATURE_LVD_MONITOR_1_HI_THRESHOLD               ((lvd_threshold_t) 4)  // 3.14V
#define BSP_FEATURE_LVD_MONITOR_1_LOW_THRESHOLD              ((lvd_threshold_t) 15) // 1.71V
#define BSP_FEATURE_LVD_MONITOR_2_HI_THRESHOLD               ((lvd_threshold_t) 4)  // 3.14V
#define BSP_FEATURE_LVD_MONITOR_2_LOW_THRESHOLD              ((lvd_threshold_t) 15) // 1.71V
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US      (30U)                  // Time in microseconds required for LVD1 to stabilize
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US      (30U)                  // Time in microseconds required for LVD2 to stabilize
